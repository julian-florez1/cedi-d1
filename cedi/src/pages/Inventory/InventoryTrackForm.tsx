    ...
    return (
        <div className="flex flex-col gap-4 p-4 bg-white rounded-lg shadow w-96">
            ...
            <div className="flex flex-col gap-1">
                <input
                    {...register('productoId', { required: 'El id del producto es requerido' })}
                    placeholder='Ej. 1'
            ...
            <div className="flex flex-col gap-1">
                <input
                    {...register('bodegaOrigenId', { required: 'La bodega de origen es requerido' })}
            ...
            <div className="flex flex-col gap-1">
                <input
                    {...register('bodegaDestinoId', { required: 'La bodega de destino es requerido' })}
